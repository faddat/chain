...
// GetCmdQueryModuleAccountBalance implements a command to return the current minting parameters.
...
// GetCmdQueryTotalClaimable implements the query claimables command.
